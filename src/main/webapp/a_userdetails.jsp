...
=======
                    <a href="tem_index.html"> <span><i class="fas fa-columns"
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
                ...
                <!-- manage account -->
                <li class="menu-item">
                    <a href="ad_userlist" class="active"> <span><i class="fas fa-user-circle"
...
=======
                                        <select name="role" id="" class="form-control table-user__body--select">
                                            <option value="1" class="" <c:if test="${account.roleId == 1}">selected</c:if>>
                                                    Admin</option>
                                                <option value="2" class="" <c:if test="${account.roleId == 2}">selected</c:if>>
                                                    Salesman</option>
                                                <option value="3" class="" <c:if test="${account.roleId == 3}">selected</c:if>>
                                                    Marketer</option>
                                                <option value="4" class="" <c:if test="${account.roleId == 4}">selected</c:if>>
                                                    Khách hàng</option>
                                            </select>
                                        </div>
                                    </div>
