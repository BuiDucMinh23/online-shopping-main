                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart__product__item d-flex">
                                                        ...
                                                        <div class="cart__product__item__title">
                                                            ...
                                                            <c:if test="${productSize.getById(cp.cateSizeId).cateSizeName ne 'over'}">
                                                                <h8>Phân Loại Hàng: ${productSize.getById(cp.cateSizeId).cateSizeName}</h8>
                                                                </c:if>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="cart__quantity">
                                                        <div class="pro-qty d-flex">
                                                            ...
                                                            <input type="text" readonly value="${cp.cartQuantity}">
        ...
        <div id="toast" class="hide">
            <div class="toast">
                ...
                <div class="toast__body">
                    <p class="toast__body--msg">Vui lòng chọn sản phẩm trước khi thanh toán</p>
                </div>
            </div>
        </div>
        <!--pop-up notification-->
