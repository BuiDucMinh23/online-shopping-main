                                    ...
                                    <div class="filter--category my-3">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <c:forEach items="${listCateSize}" var="lcs">

                                                    <div class="col-md-4">
                                                        <input type="checkbox" class="filter--size my-3 mr-1" name="filterSize" id="${lcs}" value="${lcs}" onchange="change()"><label for="${lcs}"> ${lcs} |</label>
                                                    </div>
                        ...
                        <c:choose>
                            <c:when test="${checkPrice eq null}" >
                                <form id="submitPage" action="pub_viewproductlistbycategory" method="get">
                                    ...
                                    <input type="hidden" name="CategoryProductId" value="${categoryProductId}"/>
                                    <input type="hidden" name="CategoryProductDetailsId" value="${categoryProductDetailsId}"/>
                                    <!--<input type="hidden" name="filterPage" value="pageSearch"/>-->
                                </form>
                            </c:when>
                            <c:otherwise>
