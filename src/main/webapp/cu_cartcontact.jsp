                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="box_order_cart">
                                <div class="box_order_cart__promotion">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="mypromotion">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#mypromotion_body" aria-expanded="true" aria-controls="mypromotion">
                                                Ưu đãi của bạn
                                            </button>
                                        </h2>
                                        <div id="mypromotion_body" class="accordion-collapse collapse show" aria-labelledby="mypromotion">
                                            <div class="accordion-body">
                                                <div class="input-group">
                                                    <input type="hidden" class="form-control" value="113.177.9.120-20240117-21" id="CheckoutID">
                                                    <input type="text" class="form-control" name="Voucher" id="Voucher" placeholder="Nhập mã giảm giá">
                                                    <button type="button" class="btn btn-outline-secondary btn-voucher" data-url="thanh-toan">Áp dụng</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
