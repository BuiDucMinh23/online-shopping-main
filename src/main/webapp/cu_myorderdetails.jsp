                                ...
                                <div class="bill ">
                                    ...
                                    <div class="text-right pb-2">
                                        <c:if test="${order.orStatus eq 'delivered' || order.orStatus eq 'cancelled'}">
                                            <c:if test="${order.orStatus eq 'delivered'}">
                                                <a href="#" class="btn btn-feedback mr-2"><button>Đánh Giá</button></a>
                                            </c:if>
...
<!--                                        <tr>
                                            <td><div class="text__bill text-end">Phương thức Thanh toán</div></td>
                                            <td><div class="text__bill text-end"></div></td>
                                        </tr>-->
                                    </table>
                                </div>
                            </div>
