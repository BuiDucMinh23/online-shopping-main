...
=======
                            <div class="show mb-3 justify-content-between" style="font-family: sans-serif">
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
                                <div class="show">
...
=======
                                            <option value="4" <c:if test="${quantity == 4}">selected</c:if>>4 bài viết</option>
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <a class="d-flex gap-3" href="pub_postdetail?newsId=${lp.newsId}">
                                                ...
                                                <div class="product__item__text text-left" style="padding: 0; max-width: 75%">
                                                    ...
                                                    <p>${acc_dao.getAccByEmpId(lp.emId).accName} • <span class="font-italic">${lp.newsCreatedDate}</span></p>
                                                </div>
                                            </a>
                                        </div>                             
                                    </c:forEach>
...
=======
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            ...
                                            <div class="product__item__text" style="padding: 0;">
                                                <h6><span style="font-size:30px; font-family: sans-serif;"><em><strong><a href="pub_postdetail?newsId=${lp.newsId}">${lp.newsTitle}</a></strong></em></span></h6>
                                            </div>
                                        </div>                             
                                    </c:forEach>
                                </div>
...
=======
                    <div class="col-lg-4 col-md-6 col-sm-7">
                        <div class="footer__about">
                            ...
                            <div class="footer__payment">
                                <a href="#"><img src="https://th.bing.com/th/id/OIP.pn3RUm1xk1HiAxWIgC6CIwHaHa?rs=1&pid=ImgDetMain" alt=""
                                                 style="width: 42px; height: 42px;"></a>
                                <a href="#"><img src="https://warburgpincus.com/wp-content/uploads/2018/10/MoMo_logo-1.png" alt=""
                                                 style="width: 42px; height: 42px;"></a>
                            </div>
                        </div>
                    </div>
