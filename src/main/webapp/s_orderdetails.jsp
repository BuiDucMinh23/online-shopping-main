    ...
    <body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
        ...
        <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
            ...
            <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                <!-- Dashboard -->
                <li class="menu-item">
                    <a href="s_dashboard.jsp"> <span><i class="fas fa-columns" style="width: 14px; height: 14px;"></i>Dashboard</span>
                    </a>
                </li>
                <!-- /Dashboard -->
                ...
                <li class="menu-item">
                    ...
                    <ul id="order" class="collapse" aria-labelledby="order" data-parent="#side-nav-accordion">
                        ...
                        <li> <a href="sale_order?type=delivering" class="unactive">Đơn hàng đang chờ xử lý</a>
                        </li>
                        <li> <a href="sale_order?type=pending" class="unactive">Đơn hàng đang giao</a>
                        </li>
                    </ul>
                </li>
                <!-- order -->
...
<<<<<<< HEAD
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="javascript:void(0)" id="deleteButton" class="btn btn-danger mr-2 mb-2" onclick="confirmDelete()">Xóa</a>
                                        </div>
=======
                                            <!--<a href="javascript:history.go(-1)" class="btn btn-primary ml-2 mb-2">Quay lại</a>-->
                                        </c:if>
                                        <c:if test="${requestScope.type != null}">
                                            <a href="sale_order?type=${type}" class="btn btn-primary ml-2 mb-2">Quay lại</a>
                                            <!--<a href="javascript:history.go(-1)" class="btn btn-primary ml-2 mb-2">Quay lại</a>-->
                                        ...
                                        <c:if test="${requestScope.status ne 'Đã giao hàng' && requestScope.status ne 'Đã hủy'}">
                                            <div class="d-flex justify-content-between">
                                                <a href="javascript:void(0)" class="btn btn-primary mr-2 mb-2" onclick="showFormEdit()">Chỉnh sửa</a>
                                                <!--<a href="javascript:void(0)" class="btn btn-danger mr-2 mb-2" onclick="showFormEdit()">Xóa</a>-->
                                            </div>
                                        </c:if>
...
<<<<<<< HEAD
                                                ...
                                                function confirmDelete() {
                                                    var orderId = '${requestScope.order.orId}';
