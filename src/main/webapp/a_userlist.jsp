...
=======
                    <a href="a_dashboard.jsp"> <span><i class="fas fa-columns"
                                                        style="width: 14px; height: 14px;"></i>Dashboard</span>
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
                ...
                <!-- register account -->
                <li class="menu-item">
                    <a href="a_register.jsp"> <span><i class="fas fa-user-plus"
...
=======
                                                    <option value="2" class="select__option">Marketer</option>
                                                    <option value="3" class="select__option">Salesman</option>
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
...
=======
                                                        <td>
                                                            <select name="role" class="form-control" onchange="updateInfo(${acc.accId}, '${acc.accStatus}', this.value)">
                                                                <option value="1" class="select__option"
                                                                        <c:if test="${acc.roleId == 1}">selected</c:if>>
                                                                            Admin</option>
                                                                        <option value="2" class="select__option"
                                                                        <c:if test="${acc.roleId == 2}">selected</c:if>>
                                                                            Salesman</option>
                                                                        <option value="3" class="select__option"
                                                                        <c:if test="${acc.roleId == 3}">selected</c:if>>
                                                                            Marketer</option>
                                                                        <option value="4" class="select__option"
                                                                        <c:if test="${acc.roleId == 4}">selected</c:if>>
                                                                            Khách hàng</option>
                                                                </select>
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
                                                            </td>
