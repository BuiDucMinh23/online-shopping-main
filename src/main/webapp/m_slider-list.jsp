...
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
                                            <div class="dropdown" style="display: flex">
                                                ...
                                                <div style="position: relative; top: 29px" class="mx-2">
                                                    <form id="status" action="mkt_sliderlist" method="get">
                                                        <!--<inline>Slider nhiều lượt xem nhất</inline>-->

                                                        <!--<input type="radio" name="sortByView" ${sortByView eq 'sortByView'?'checked':''} onchange="change()" value="sortByView" />-->
                                                        <input type="hidden" name="sliderStatus" value="${sliderStatus}"/>
                                            ...
                                            <c:forEach items="${requestScope.listNews}" var="ln">
                                                ...
                                                <tr class="my-5">
                                                    ...
                                                    <td class="text-center align-middle">
                                                        <span>
                                                            <a href="mkt_sliderdetail?newsId=${ln.newsId}">
