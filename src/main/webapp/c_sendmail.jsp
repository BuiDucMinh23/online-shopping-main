...
<body>
    <div class="global flex-column">
        <form action="com_resetpass" class="global__form frame">
            ...
            <div class="flex-row">
                <a href="c_login.jsp" class="frame-btn frame-btn--cancel">Đóng</a>
                <a href="c_login.jsp" class="frame-btn frame-btn--login">Đăng nhập</a>
            </div>
        </form>
    </div>
</body>
