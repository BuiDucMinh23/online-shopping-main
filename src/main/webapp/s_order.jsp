    ...
    <body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar relative">
        ...
        <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
            ...
            <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                <!-- Dashboard -->
                <li class="menu-item">
                    <a href="s_dashboard.jsp"> <span><i class="fas fa-columns" style="width: 14px;
                            ...
                            <div class="ms-panel">
                                        ...
                                        <div class="filter__body">
                                            <div class="row">
                                                ...
                                                <div class="common mb-4 col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="tilteOrder" value="${tilteOrder}" />
                                                </div>

                                                <div class="common mb-4 col-md-3">
                                                    <p class="common__title">Tên khách hàng</p>
                                                    <input type="text" class="form-control" name="nameCustomer" value="${nameCustomer}" />
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="common mb-4 col-md-3">
                                                    ...
                                                    <select name="statusOrder" id="" class="form-control table-user__body--select">
                                                        <option style="" value="all"  ${status eq 'all' ? 'selected' : ''}>Tất cả</option>
                                ...
                                <div class="ms-panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <div class="d-flex justify-content-center"><p style="font-size: 24px;">${requestScope.messError}</p></div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="text-right mr-1">
                                                <c:if test="${pageNumber > 1}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" href="sale_order?index=${pageNumber-1}">Trước</a>
                                                </c:if>
                                                ...
                                                <c:choose>
                                                    <c:when test="${requestScope.endPage > 5}">
                                                        ...
                                                        <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                                            <a class="btn btn-page mb-1 px-2 py-1 ${pageNumber == i ? 'active' : ''}" style="min-width: 1.25rem" href="sale_order?index=${i}">${i}</a>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <c:if test="${pageNumber < endPage}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" href="sale_order?index=${pageNumber+1}">Sau</a>
                                                </c:if>
                                            </div>
                                        </div>
                                        <!--End Pagination-->
        ...
        <!--pop-up notification-->
<<<<<<< HEAD
        <div id="toast" class="${status == 'delete' ? '' : 'hide'}">
=======
...
<<<<<<< HEAD
                    <p class="toast__body--msg">
                        <c:if test="${status eq 'delete'}">Xóa đơn hàng thành công</c:if> 
                        <c:if test="${status ne 'delete'}">Chuyển trạng thái thành công</c:if> 
                    </p>
=======
