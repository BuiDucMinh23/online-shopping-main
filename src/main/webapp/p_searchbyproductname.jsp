                            ...
                            <form id="dosearch" action="pub_filterpriceandsizeproduct" method="get">
                                <div>
                                    ...
                                    <div class="filter--category my-3">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                <c:set var="check" value="over"/>
                                                <c:forEach items="${requestScope.listCateSize}" var="lcs">
                                                    <c:if test="${lcs.cateSizeName ne check}">
                                                        <div class="col-md-4">
                                                            <input type="checkbox" class="filter--size my-3 mr-1" name="filterSize" id="${lcs.cateSizeName}" value="${lcs.cateSizeName}" onchange="change()"><label for="${lcs.cateSizeName}"> ${lcs.cateSizeName} |</label>
                                                        </div>
                                                    </c:if>
                                                </c:forEach>
