                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 p-0" >
                                <div class="categories__item set-bg" data-setbg="${ProDaoAo[11].proImgDefault}">
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-8 w-100" ">
                        <div class="banner__slider owl-carousel" style="padding: 0;">
                            <c:forEach items="${requestScope.listSlider}" var="ls">
                                <div class="banner__item">
                                    <div class="banner__text">
                                        <img src="${ls.newsImgUrl}" alt="alt" style="height: 400px;"/>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
