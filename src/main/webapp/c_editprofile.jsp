                ...
                <c:if test="${sessionScope.account.roleId == 2}">
                    ...
                    <c:if test="${sessionScope.account.roleId == 3}">
                        ...
                        <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                            ...
                            <!-- News Begin -->
                            <li class="menu-item">
                                <a href="#" class="has-chevron" data-toggle="collapse" data-target="#invoice" aria-expanded="false" aria-controls="invoice"> <span><i class="fas fa-newspaper"></i>Tin tức</span>
                                </a>
                                <ul id="invoice" class="collapse" aria-labelledby="invoice" data-parent="#side-nav-accordion">
                                    ...
                                    <li> <a href="pages/invoice/invoicelist.html">Slider</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- News End -->
