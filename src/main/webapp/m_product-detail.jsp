                    ...
                    int cnt = 2;
                                            ...
                                            <div class="ms-stats-grid col-lg-4" style="border:none;">
                                                ...
                                                <c:forEach items="${requestScope.listCateSize}" var="lcs">
                                                    <c:if test="${lps.cateSizeId == lcs.cateSizeId}">
                                                        ...
                                                        <p class="ms-text-dark"><input class="form-control my-1" name="proSizeQuantity${lcs.cateSizeName}" style="width: 40%;height: 10%; margin: 0 auto; text-align: center;font-weight: bold"  type="text" id="numberInput<%= cnt %>" placeholder="" value="${lps.proSizeQuantity}" required> </p>
                            ...
                            <div class="ms-quick-stats" style="margin-bottom:40px;">
                                <div class="ms-stats-grid">
                                    ...
                                    <!--<h6 style="color:red">${errorInputSold}</h6>-->
                                </div>
                                <div class="ms-stats-grid">
                                    ...
                                    <!--<h6 style="color:red">${errorInputRating}</h6>-->
                                </div>
                            </div>
