                                        ...
                                        <li>
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <div class="size__btn">
                                                        <label for="s-btn">
                                                            <input type="radio" name="size" id="s-btn" value="S">S
                                                        </label>
                                                        <label for="m-btn">
                                                            <input type="radio" name="size" id="m-btn" value="M">M
                                                        </label>
                                                        <label for="l-btn">
                                                            <input type="radio" name="size" id="l-btn" value="L">L
                                                        </label>
                                                    </div>
                                                </c:otherwise>
                                            </c:choose>
                                ...
                                <div class="product__details__button">
                                    <div class="quantity">
                                        ...
                                        <div class="pro-quantity">
                                            ...
                                            <input type="text" id="quantityInput" value="1" name="quantity">
                                    ...
                                    <c:if test="${sessionScope.account == null}" >
                                        <div class="product__cart-btn">
                                            <a href="c_login.jsp" class="cart-btn cart__btn--left"><span class="icon_bag_alt"></span> Thêm vào giỏ hàng </a>
                                            <a href="c_login.jsp" class="cart-btn cart__btn--right"><span class=""></span> Mua ngay </a>
                                        </div>
                                    </c:if>
