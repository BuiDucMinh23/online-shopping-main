                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="text-right mr-1">
                                                <c:if test="${pageNumber > 1}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" href="sale_order?type=delivered&index=${pageNumber-1}">Trước</a>
                                                </c:if>
                                                ...
                                                <c:choose>
                                                    <c:when test="${requestScope.endPage > 5}">
                                                        ...
                                                        <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                                            <a class="btn btn-page mb-1 px-2 py-1 ${pageNumber == i ? 'active' : ''}" style="min-width: 1.25rem" href="sale_order?type=delivered&index=${i}">${i}</a>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <c:if test="${pageNumber < endPage}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" href="sale_order?type=delivered&index=${pageNumber+1}">Sau</a>
                                                </c:if>
                                            </div>
                                        </div>
                                        <!--End Pagination-->
