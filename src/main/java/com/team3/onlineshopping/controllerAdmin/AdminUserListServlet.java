...
=======
        out.println("    <td>");
        out.println("        <select name=\"role\" class=\"form-control\" onchange=\"updateInfo(" + acc.getAccId() + ", '" + acc.getAccStatus() + "', this.value)\">");
        out.println("           <option value=\"1\" class=\"select__option\"" + (acc.getRoleId() == 1 ? " selected" : "") + ">Admin</option>");
        out.println("           <option value=\"2\" class=\"select__option\"" + (acc.getRoleId() == 2 ? " selected" : "") + ">Salesman</option>");
        out.println("           <option value=\"3\" class=\"select__option\"" + (acc.getRoleId() == 3 ? " selected" : "") + ">Marketer</option>");
        out.println("           <option value=\"4\" class=\"select__option\"" + (acc.getRoleId() == 4 ? " selected" : "") + ">Khách hàng</option>");
        out.println("        </select>");
