...
//        System.out.println(abc.getStatisticAccountByMonths().size());
        System.out.println(abc.getById(76).toString());
=======
    public static void main(String[] args) {
        System.out.println("==========");
        AccountDAO abc = new AccountDAO();
        System.out.println(abc.getAll().size());

//        List<Account> list = abc.getAll();
//        for (Account account : list) {
//            System.out.println(account.getAccName());
//        }
//        Account t = new Account(12, "Cái gì dây", "dsadas", "sdasdas", "Nguyễn Huy Thái", "sdasdas", "2022-12-10", "2022-12-10", "sdasdas", 1);
        abc.add(new Account(14, "abc@gmaill.com", UserAccount.encodeToSHA1("123asd"), "0989898989", "Ke Duyen", "", "", "", "on", 2));

//        abc.add(t);
//        System.out.println(abc.getById(3).getAccName());
//        Account acc = new Account(10, "nnnnnnnnnnnnnnn", "dsadas", "sdasdas", "sdasdas",
//                "sdasdas", "2000-12-10", "2022-12-10", "sdasdas", 1);
//        abc.update(acc);
//        System.out.println(a.getAll().size());
//        Account acc = new Account(11, "cai noi gi day", "dsadas", "sdasdas", "sdasdas", "sdasdas", "sdasdas", 1);
//        abc.delete(10);
//        Account acc = abc.getById(8);
//        acc.setAccName("Ngu 123 2435235");
//        abc.update(acc);
//        System.out.println(abc.getAccByCusId(1).getAccName());
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
    }
}
