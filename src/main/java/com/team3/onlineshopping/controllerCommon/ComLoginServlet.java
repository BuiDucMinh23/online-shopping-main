...
public class ComLoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//                        request.getRequestDispatcher("z.jsp").forward(request, response);
...
//                    request.getRequestDispatcher("sale_dashboard").forward(request, response);
                ...
                case 3:
                    ...
                    break;
=======
                case 4 -> request.getRequestDispatcher("pub_home").forward(request, response);
                case 1 -> request.getRequestDispatcher("a_dashboard.jsp").forward(request, response);
                case 2 -> request.getRequestDispatcher("s_dashboard.jsp").forward(request, response);
                case 3 -> request.getRequestDispatcher("m_dashboard.jsp").forward(request, response);
