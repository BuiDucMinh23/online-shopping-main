...
=======
        List<News> lNews = nDao.splitPagePost(4, 1, "", "", "", "on");
        int numberPage = (int) Math.ceil((double) nDao.getTotalPost("on")/ 4);
...
=======
        ...
        out.println("<div class=\"product__item__pic\">" + news.getNewsImgUrl() + "</div>");
        out.println("<div class=\"product__item__text\" style=\"padding: 0;\">");
        out.println("<h6><span style=\"font-size:30px; font-family: sans-serif;\"><em><strong><a href=\"pub_postdetail?newsId=" + news.getNewsId() + "\">" + news.getNewsTitle() + "</a></strong></em></span></h6>");
//        out.println("<div class=\"long-text\">Date:" + news.getNewsCreatedDate() + "</div>");
        out.println("</div>");
        out.println("</div>");
>>>>>>> ac25e0a102a7e3e17fcb871226267f3b81ee7242
    }
